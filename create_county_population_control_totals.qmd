...
NYS gets annual estimates from the Census Bureau. The 2025-04-20 version has county population totals for 1970-2023. The data may be slightly behind what Census has currently.

The data look like this:

![](images/paste-2.png)

There are 62 counties – 5 NYC counties, 57 counties, and a New York State total.

https://data.ny.gov/Government-Finance/Annual-Population-Estimates-for-New-York-State-and/krt9-ym2k/about_data

## get-nysdol-county-pop

```{r}
#| label: get-nysdol-county-pop
#| eval: false
