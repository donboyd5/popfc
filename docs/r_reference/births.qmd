...
Compare sources of births data. Construct birth estimates.
...
-   Fertility -- Perplexity/Claude:

-   **Crude birth rate**: The birth rate (or crude birth rate) is the number of live births in a year per 1,000 people in the total population, regardless of age or sex. It gives a broad measure of how many births occur in a population overall.

-   **General fertility rate**: The general fertility rate is the number of live births in a year per 1,000 women of childbearing age (usually ages 15–44 or 15–49). It is a more specific indicator than the crude birth rate because it only considers the population at risk of giving birth.

-   **Total fertility rate**: The total fertility rate is the average number of children that would be born to a hypothetical woman if she survived through her childbearing years and experienced the current age-specific fertility rates throughout her life. *This is an age-adjusted rate.* In developed countries TFR of 2.1 is considered replacement level.
...
The checks below show that Census calculates birth rates as births / (avg pop of current and prior year) \* 1000. For example, birth rate in 2018 = births in 2018 / avg pop of 2018 and 2017, x 1000.
