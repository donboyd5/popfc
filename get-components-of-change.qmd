...
coc |>
  ...
  filter(vtype == cvtype, variable == cvar) |>
  # mutate(value = ifelse(year %in% c(2000, 2010, 2020), NA_real_, value)) |>
...
# to compute npopchg_2002, you’d typically need:
